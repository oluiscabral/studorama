            ...
            <label className="flex items-start space-x-3 cursor-pointer">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm mt-1" style={{ color: themeConfig.colors.textSecondary }}>
                  {language === 'pt-BR' 
                    ? 'Não mostrar este diálogo novamente ao trocar de idioma. Você pode alterar esta preferência nas configurações.'
                    : 'Don\'t show this dialog again when switching languages. You can change this preference in settings.'
                  }
                </p>
              </div>
            </label>
