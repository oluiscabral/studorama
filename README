...
![Studorama Logo](public/favicon.ico)
...
- 🐙 GitHub: [@oluiscabral](https://github.com/oluiscabral)
- 💼 LinkedIn: [oluiscabral](https://www.linkedin.com/in/oluiscabral)
...
- 🐛 **Bug Reports**: [Open an issue](https://github.com/oluiscabral/studorama/issues)
- 💡 **Feature Requests**: [Start a discussion](https://github.com/oluiscabral/studorama/discussions)
- 📧 **Direct Contact**: [LinkedIn](https://www.linkedin.com/in/oluiscabral)
...
**Made with ❤️ by [oluiscabral](https://github.com/oluiscabral)**
